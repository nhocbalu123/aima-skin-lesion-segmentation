...
- Program context: guided AIMA Research Lab Research Warm-up Program.
- Historical implementation: preserved in `notebooks/original_pipeline.ipynb` from repository commit `812365248587d61a0cf163fa9f8a0f7804667ae5` and the uploaded working tree.
- Maintained implementation: modular package, synthetic tests, CI, documentation, submission-contract repair, and reproducibility evidence added during the correctness repair.
- Controlled rerun: completed on Kaggle on 2026-07-29; compact artifacts are stored in `results/controlled_rerun/`.
